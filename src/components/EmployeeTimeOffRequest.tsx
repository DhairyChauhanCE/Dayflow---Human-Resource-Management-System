...
interface EmployeeTimeOffRequestProps {
  isOpen: boolean;
  onClose: () => void;
  employee: any;
}

export function EmployeeTimeOffRequest({ isOpen, onClose, employee }: EmployeeTimeOffRequestProps) {
      ...
      >
        ...
        <form onSubmit={(e) => void handleSubmit(e)} className="space-y-6">
          ...
          <div>
            ...
            <div className="bg-[#050505] border border-white/20 rounded-lg px-4 py-3 text-white">
          ...
          <div>
            ...
            <div className="bg-[#050505] border border-white/20 rounded-lg px-4 py-3 flex items-center">
              <span className="text-white font-medium">
                {calculateDays().toFixed(2).padStart(2, '0')} Days
              </span>
            </div>
          </div>
